...
| DRG Code | DRG Description | Relative Weight | Huntsville Cases | Huntsville % | National % | Ratio vs. National | Clinical Insight |
| :--- | :--- | :---: | :--- | :--- | :---: | :--- | :--- |
| **292** | Heart Failure & Shock with CC | **0.8612** | 45 | 0.489% | 0.104% | **4.71x** | Patients are being coded with minor comorbidities (CC) rather than major acuity (MCC), leading to leakage from DRG 291 (Weight: 1.3048). |
| **455** | Combined Ant/Post Spinal Fusion without CC/MCC | **4.6056** | 90 | 0.977% | 0.213% | **4.59x** | Major spine surgery patients are being billed with zero captured comorbidities, indicating a massive documentation gap. *(Note: DRG 455 was deleted in FY 2025 and replaced by new multi-tier spinal fusion codes, e.g., 426–428).* |
| **234** | Coronary Bypass w Cath without MCC | **5.3202** | 42 | 0.456% | 0.112% | **4.09x** | Complex CABG patients are falling into the lower payment tier due to missing MCCs. |
| **331** | Major Bowel Procedures without CC/MCC | **1.6510** | 56 | 0.608% | 0.235% | **2.59x** | Major abdominal surgeries are billed in the baseline tier, indicating severe under-documentation. |
| **191** | COPD with CC | **0.8591** | 51 | 0.554% | 0.232% | **2.39x** | Patients admitted with acute COPD exacerbations are coded with only minor complications, representing leakage from DRG 190 (Weight: 1.1230). |
| **178** | Respiratory Infections & Inflams with CC | **0.9921** | 94 | 1.021% | 0.534% | **1.91x** | Lower-severity pneumonia/respiratory infections are over-represented, representing leakage from DRG 177 (Weight: 1.6165). |
...
| DRG Code | DRG Description | Relative Weight | Huntsville Cases | Huntsville % | National % | Difference vs. National (Relative) | Clinical Insight |
| :--- | :--- | :---: | :--- | :--- | :---: | :---: | :--- |
| **871** | Septicemia or Severe Sepsis with MCC | **1.9621** | 814 | 8.838% | 11.653% | **-24.16%** | Sepsis represents your largest single volume cohort; missing MCCs here significantly depresses Case Mix Index. |
| **291** | Heart Failure & Shock with MCC | **1.3048** | 389 | 4.224% | 6.152% | **-31.34%** | Under-billing of severe CHF (DRG 291) corresponds directly with the over-billing of DRG 292 (Weight: 0.8612). |
| **193** | Simple Pneumonia & Pleurisy with MCC | **1.3177** | 108 | 1.173% | 2.759% | **-57.48%** | Severe pneumonia is under-coded, directly impacting risk-adjusted mortality indices. |
| **189** | Pulmonary Edema & Respiratory Failure | **1.2374** | 63 | 0.684% | 1.817% | **-62.36%** | Primary respiratory failure admissions are under-documented or shifted to infection codes. |
| **190** | COPD with MCC | **1.1230** | 51 | 0.554% | 1.003% | **-44.77%** | Severe COPD cases are under-billed, matching the shift to the CC-only tier of DRG 191 (Weight: 0.8591). |
