...
out_csv_path = os.path.join(base_dir, "data", "Huntsville_DRG_Outlier_Full_Analysis.csv")
comparison.to_csv(out_csv_path, index=False)
print(f"\nFull comparison saved to '{out_csv_path}'")
